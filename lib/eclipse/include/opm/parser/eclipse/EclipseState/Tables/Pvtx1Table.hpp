 ...
 */
#ifndef OPM_PARSER_PVTX1_TABLE_HPP
#define	OPM_PARSER_PVTX1_TABLE_HPP
...
*/
 ...
 namespace Opm {
    ...
    public:
        ...
        explicit Pvtx1Table(const std::string& columnName);
        ...
        //sogo
        const SimpleTable& getRsTable(size_t tableNumber) const;
    ...
    protected:
        ...
        //sogo
        TableSchema m_rsSchema;
        std::vector< SimpleTable > m_rsTables;
    };
